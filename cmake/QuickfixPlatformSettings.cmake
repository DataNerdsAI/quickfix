...
if(NOT WIN32)
find_file (FOUND_ALLOCATOR_HDR NAMES Allocator.h PATHS ${QUICKFIX_CMAKE_SOURCE_DIR}/src/C++/ NO_DEFAULT_PATH)
if (NOT FOUND_ALLOCATOR_HDR)
message("-- Generating empty Allocator.h")
file(WRITE ${QUICKFIX_CMAKE_SOURCE_DIR}/src/C++/Allocator.h
     "/* Empty file generated by cmake, can be replaced by a custom file */\n"
 )
file(COPY ${QUICKFIX_CMAKE_SOURCE_DIR}/src/C++/Allocator.h DESTINATION ${QUICKFIX_CMAKE_SOURCE_DIR}/include/quickfix)
endif()

find_file (FOUND_CONFIG_HDR NAMES config.h PATHS ${QUICKFIX_CMAKE_SOURCE_DIR} NO_DEFAULT_PATH)
if (NOT FOUND_CONFIG_HDR)
message("-- Generating empty config.h")
file(WRITE ${QUICKFIX_CMAKE_SOURCE_DIR}/config.h
     "/* Empty file generated by cmake, can be replaced by a custom file */\n" )
endif()
endif()
